...
Answer all questions related to rainwater harvesting, water conservation, environmental sustainability, and related topics. If asked about unrelated topics, politely redirect to rainwater harvesting."""
    ...
    def get_fallback_response(self, message: str) -> str:
        ...
        # Import the rule-based chatbot for better responses
        from .chatbot import chatbot
        
        try:
            # Use the more sophisticated rule-based chatbot as fallback
            ...
            if any(word in message_lower for word in ['define', 'definition', 'what is', 'meaning', 'explain', 'describe']):
                if 'rainwater harvesting' in message_lower or 'rain water harvesting' in message_lower:
                    return "🌧️ **Rainwater Harvesting Definition**:\n\nRainwater harvesting is the **collection, storage, and use of rainwater** from rooftops and other surfaces.\n\n**How it works**:\n1. Rain falls on your roof\n2. Gutters collect the water\n3. Filters clean the water\n4. Tanks store it for later use\n\n**Benefits**: Saves money, conserves water, prevents flooding, and ensures water security!"
                else:
                    return "I can help define rainwater harvesting concepts! What specific term would you like me to explain?"
            ...
            elif any(word in message_lower for word in ['cost', 'price', 'money', 'budget']):
            ...
            elif any(word in message_lower for word in ['rainfall', 'rain', 'data', 'weather']):
            ...
            elif any(word in message_lower for word in ['calculate', 'calculator', 'how', 'use']):
            ...
            elif any(word in message_lower for word in ['district', 'city', 'location', 'place']):
